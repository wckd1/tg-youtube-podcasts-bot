...
func NewEpisode(id, audioType, url, link, cover, title, description, author string, publishDate time.Time, length, duration int) Episode {
...
func (e Episode) PublishDate() time.Time { return e.publishDate }
